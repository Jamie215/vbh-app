    ...
    overlay.innerHTML = `
        <div class="bg-white rounded-xl p-4 max-w-[900px] w-full relative">
            ...
            <div class="aspect-video w-full rounded-lg overflow-hidden bg-black">
                <iframe src="https://www.youtube.com/embed/dsg0hMkCIQw?rel=0&modestbranding=1" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="w-full h-full"></iframe>
            </div>
        </div>
    `;
