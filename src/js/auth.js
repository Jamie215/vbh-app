...
function getAgreementPlaceholderHTML() {
    return `
        ...
        <p class="mb-4">The application is provided for research and educational purposes and is not a substitute for medical advice. Participants should consult their healthcare provider before beginning the exercise program. This program may ask you to perform exercises you are not used to doing. You are expected to review the tutorial videos and get advice on how to perform exercises safely. Check to make sure that you have a clear space void of obstacles to reduce the risk of injury. If you do not feel safe doing the exercises or experience any unusual symptoms, stop immediately and reach out to your healthcare provider and the research team.</p>
